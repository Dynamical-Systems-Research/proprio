"""Built-in reduced-order simulators for the published reference skills."""
...
class _PlateReaderController(SimulatedController):
...
class CalibratedPumpController(SimulatedController):
...
class DualPumpController(SimulatedController):
    family = "calibrated_delivery"
...
class _ThermalController(SimulatedController):
...
class SimulatedControllerDefinition:
    instrument_id: str
    family: str
    controller_type: type[SimulatedController]
...
SIMULATED_CONTROLLERS = {
    "absorbance-plate-read": SimulatedControllerDefinition(
    ...
    "fluorescence-plate-read": SimulatedControllerDefinition(
    ...
    "calibrated-pump-dose": SimulatedControllerDefinition(
    ...
    "dual-pump-blend": SimulatedControllerDefinition(
        "dual-pump-blend",
        "calibrated_delivery",
        DualPumpController,
    ...
    "isothermal-hold": SimulatedControllerDefinition(
        "isothermal-hold",
        "thermal_control",
    ...
    "thermal-cycle": SimulatedControllerDefinition(
        "thermal-cycle",
        "thermal_control",
...
def build_simulated_controller(
    instrument_id: str,
    scenario: SimulationScenario,
) -> SimulatedController:
    return SIMULATED_CONTROLLERS[instrument_id].controller_type(scenario)
