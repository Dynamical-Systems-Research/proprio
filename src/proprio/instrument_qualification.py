...
def compile_instrument_skill(source: str, allowed_methods: frozenset[str]) -> FunctionType:
...
def evaluate_controller_skill(
    ...
    *,
    ...
    """Run one straight-line skill against a supplied controller and physical verifier."""
