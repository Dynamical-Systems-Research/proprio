"""Model interaction loop for evidence-grounded instrument-skill repair."""
...
SKILL_EXECUTOR_CONTRACT = """

Bounded executor contract (complete and authoritative):
...
QUALIFIED_SKILL_SYSTEM_PROMPT = SKILL_ENGINEER_SYSTEM_PROMPT + SKILL_EXECUTOR_CONTRACT


class SkillRepairEpisode(BaseModel):
    model_config = ConfigDict(extra="forbid", frozen=True)

    schema_version: Literal["proprio.skill_repair.v0.4"] = "proprio.skill_repair.v0.4"
    instrument_id: str
...
class SkillAgent(InstrumentSkillAgent):
    def __init__(
        ...
        *,
        ...
        super().__init__(
            client=client,
            skill_system_prompt=QUALIFIED_SKILL_SYSTEM_PROMPT,
    ...
    def repair_candidate(
        ...
        *,
        ...
        messages: list[dict[str, Any]] = [
            {"role": "system", "content": QUALIFIED_SKILL_SYSTEM_PROMPT},
